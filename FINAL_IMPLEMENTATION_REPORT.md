...
| 命令/范围 | 结果 | 证据 |
|---|---|---|
| `PYTHONPATH=backend .venv/bin/python scripts/test_postgres.py .venv/bin/pytest --junitxml=evidence/stage8-care-validity-postgres.xml` | PASS，197项 | [PostgreSQL回归](evidence/stage8-care-validity-postgres.xml) |
...
| `npm --prefix miniapp test` | PASS，12项 | [Node执行记录](evidence/stage8-care-validity-green.tap) |
