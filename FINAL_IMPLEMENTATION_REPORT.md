...
| 命令/范围 | 结果 | 证据 |
|---|---|---|
| `PYTHONPATH=backend .venv/bin/python scripts/test_postgres.py .venv/bin/pytest --junitxml=evidence/stage8-worker-atomic-postgres.xml` | PASS，184项 | [PostgreSQL回归](evidence/stage8-worker-atomic-postgres.xml) |
